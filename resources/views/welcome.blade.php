...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <script>
            ...
            let h1Element = document.querySelector('.welcome_text_box h1');
            let h3Element = document.querySelector('.welcome_text_box h3');
            let imagePerson = document.querySelector('.content_image_cont');

            imagePerson.classList.add('bottom-to-top-animate');
            h1Element.classList.add('right-animation1');
            h3Element.classList.add('right-animation2');
                setTimeout(function() {
                    h1Element.classList.add('increase-glow');
                    imagePerson.classList.add('image-animate');
                }, 2000);
                setTimeout(function() {
                    h3Element.classList.add('increase-glow');
                }, 2500)
            });
        </script>
    </body>
